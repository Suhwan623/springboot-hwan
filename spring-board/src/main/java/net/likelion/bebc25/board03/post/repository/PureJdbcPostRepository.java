...
public class PureJdbcPostRepository implements PostRepository {
    ...
    private final String url = "jdbc:mysql://localhost:3306/board_db?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true";
    ...
    public PostDto findById(int id) {
        ...
        String sql = "SELECT id, title, author, content, secret, created_at AS createdAt "
                + "FROM post2 WHERE id = " + id;
    ...
    public void save(PostDto post) {
        String sql = "INSERT INTO post2 (title, author, content) VALUES ('"
                + post.getTitle() + "', '"
                + post.getAuthor() + "', '"
                + post.getContent() + "')";
